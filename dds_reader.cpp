...
static const int A8B8G8R8_MASKS[] = { 0x000000FF, 0x0000FF00, 0x00FF0000, static_cast<int>(0xFF000000) };
static const int X8B8G8R8_MASKS[] = { 0x000000FF, 0x0000FF00, 0x00FF0000, 0x00000000 };
static const int A8R8G8B8_MASKS[] = { 0x00FF0000, 0x0000FF00, 0x000000FF, static_cast<int>(0xFF000000) };
...
int *ddsOriginData(const unsigned char *buffer, const int width, const int height, const DDS_ORDER *order) {
	return ddsDecodeDXT1(width, height, 0, buffer, order);
}
